              ...
              return (
                <li
                  ...
                  className={clsx(
                    ...
                    'bg-[#141c28]/60 border p-6 rounded-2xl flex',
                  ...
                  <div className={clsx('flex items-center gap-4')}>
                    ...
                    >
                      <div
                        className={clsx(
                          ...
                          ' w-5 h-5 scale-50 fixed rounded-full  transition-colors'
                        )}
                      />
                      <Circle
                        className={clsx(
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className={clsx('flex gap-2')}>
                        <span
                          className={clsx(priority.bg, priority.color, 'flex items-center gap-1.5')}
                        >
                          <Flag size={'15px'} />
                        ...
                        {todo.repeat.value > 0 && (
                          ...
                          >
                            ...
                            <span>{repeatLabels[todo.repeat.value]}</span>
                          </div>
                        )}
                      </div>
                    </div>
